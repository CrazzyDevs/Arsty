  ...
  const bidCard = [
    {
      ...
      icon: <BsHeartFill />,
      imageUrl:
        "https://res.cloudinary.com/dpokiomqq/image/upload/v1673043071/image3_c16wly.png",
    ...
    },
    {
      ...
      icon: <BsHeartFill />,
      imageUrl:
        "https://res.cloudinary.com/dpokiomqq/image/upload/v1673043076/gurl_kitzch.png",
    ...
    },
    {
      ...
      icon: <BsHeartFill />,
      imageUrl:
        "https://res.cloudinary.com/dpokiomqq/image/upload/v1673043075/image1_h3mp1a.png",
      prodctStatus: "in the box",
      higestBid: "0.45 ETH",
      creator: "agba coder",
      date: "7 / 01 / 23",
    ...
    <>
      ...
      >
        ...
        <div className=" break-words font-[switzer] first-cont">
          <h2>
            Lorem ipsum dolor sit amet, consectetur bag goods elit. Dolore{" "}
          </h2>
          <div>
            <Carousel
              partialVisible={true}
              ...
              <>
                ...
                <div className="top-bid-card">
                  <div className="card-img-cont">
                    <div className="w-full red-heart flex justify-between">
                      <h2></h2> <div className=" heart-icon ">{bid.icon}</div>
                    </div>

                    <div
                      className="top-bid-img"
                      key={bid.id}
                      style={{
                    ...
                    <div className="w-full name-price flex justify-between">
                      <h2 className="font-semibold">{bid.prodctStatus}</h2>{" "}
                      <h2 className="font-bold ">{bid.higestBid}</h2>
                    </div>
                  </div>
                  ...
                  <div className="w-full h-auto ">
                    <div className="flex flex-col gap-6 p-4 mt-5 mb-5">
                      <h2 className="font-bold">
                        <span className="font-normal pr-4">Creator : </span>{" "}
                        {bid.creator}
                      </h2>
                      <h1 className="font-bold">
                        <span className="font-normal pr-4">Date :</span>
                        {bid.date}
                      </h1>
                    </div>
